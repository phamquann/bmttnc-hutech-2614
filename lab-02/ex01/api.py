...
from cipher.transpostion import TranspostionCipher

app = Flask(__name__)

transpostion_cipher = TranspostionCipher()
...
def transpostion_encrypt():
    ...
    encrypted_text = transpostion_cipher.encrypt(plain_text, key)
...
def transpostion_decrypt():
    ...
    key = int(data.get('key'))
    decrypted_text = transpostion_cipher.decrypt(cipher_text, key)
